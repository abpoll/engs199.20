...
## This intersects with many dimensions of global change {.nostretch}

::: {#fig-haz-exp-vuln-ipcc}
![](../_assets/img/haz_exp_vuln_ipcc.png){width=500}
...
<!-- 
For the training, this note is not relevant. For future versions, can use this note. 
::: {.callout-note}
