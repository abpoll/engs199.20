...
![@Hausfather2020](../_assets/img/hausfather_scenarios_2020.jpg){width=500}

## Example: Scenario and model choices reflect "deep" uncertainty in sea-level rise projections
![@Doss-Gollin2023](../_assets/img/sea_level_deep.png)

# Neglecting uncertainty can bias decisions

## Example: Triggering managed retreat
![@Hegde-etal-2025](../_assets/img/prabhat_sys_rel.png)

## Myopic strategies
![@Hegde-etal-2025](../_assets/img/prabhat_myopia.png)

# Uncertainty characterization and sensitivity analysis

## Schematic Representation
![@Reed-etal-2025](../_assets/img/uc_sa.png)
...
![@Reed-etal-2025](../_assets/img/factor_pri_map.png)

## Analysis methods {.nostretch}
![@Reed-etal-2025](../_assets/img/sa_methods.png){width=800}
...
::: {.fragment}
![@Hegde-etal-2025](../_assets/img/prabhat_spider.jpeg)
:::
:::
...
:::{.incremental}
* Avoid using inconsistent uncertainty framing and analysis (e.g., calculating expected values when framing uncertainties as "deep")
