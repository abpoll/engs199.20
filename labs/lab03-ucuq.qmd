...
Take a look at the [online tutorials](https://uc-ebook.org/docs/html/A2_Jupyter_Notebooks.html) and see identify the uncertainty analyses that you can envision running with your project data. Pick the one that you feel is the most relevant for your decision analysis goals and run this notebook locally. If you feel that none of these tutorials map well to your goals, let's chat ;) 
...
* accurate references
  - you might only cite the MSD book and references within it, but you might also find it helpful to look beyond
