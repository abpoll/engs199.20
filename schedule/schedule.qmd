...
- [**Lab**](../labs.qmd) {{< fa sharp laptop-code >}}: This page contains a lab report rubric and links to each week's lab. You can also access each week's lab through the links in the schedule below. Please check this page to stay on top of the due dates for each lab. 
